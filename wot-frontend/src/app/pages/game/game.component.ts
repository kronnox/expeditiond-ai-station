...
export class GameComponent implements AfterViewInit {
  ...
  public ngAfterViewInit() {
      ...
      this.truck = new SpaceObject(this, this.canvasEl.width/2, this.canvasEl.height/2, 0, 0, this.truckLoc, 600, 300);
      this.animate();
  ...
  private animate(): void {
      ...
      this.ctx.drawImage(background, 0, 0, this.canvasEl.width, this.canvasEl.height);
